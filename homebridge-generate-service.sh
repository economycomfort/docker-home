#!/bin/bash
#
# Used to examine a running homebridge container and expose the correct avahi service.
# Normallt only used once after container creation.
#
# Start homebridge container
# Run this script
# Modify homebridge continer definition to expose the correct port if required.
#
# Stolen from David Hustinson:
